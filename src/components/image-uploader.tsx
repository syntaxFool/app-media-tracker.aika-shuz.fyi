  ...
  return (
    <div>
      ...
      {preview ? (
        ...
        <div className="border-2 border-dashed border-border rounded-sm p-4 animate-fade-in">
          <div className="flex gap-3">
            {/* Camera */}
            <label className="flex-1 flex flex-col items-center justify-center gap-2 p-4 rounded-sm bg-white dark:bg-gray-800 border border-border dark:border-gray-700 cursor-pointer hover:border-primary/30 transition-colors active:bg-surface dark:active:bg-gray-700">
        ...
        <div className="flex flex-col items-center justify-center border-2 border-dashed border-border rounded-sm p-6 bg-surface">
        ...
        <button
          ...
          className="w-full flex flex-col items-center justify-center border-2 border-dashed border-border rounded-sm p-6 cursor-pointer hover:border-primary/30 transition-colors bg-surface"
        >
